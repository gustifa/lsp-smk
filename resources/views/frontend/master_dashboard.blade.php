          ...
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              ...
              <div class="text-center">
                <a href="{{route('siswa.login')}}" class="btn-get-started scrollto">LOGIN <i class="bi bi-box-arrow-in-right"></i></a>
                <a href="{{route('daftar')}}" class="btn-get-started scrollto">DAFTAR <i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
