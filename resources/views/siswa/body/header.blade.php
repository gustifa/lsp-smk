				...
				<p class="msg-info">Your new product has approved</p>
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{(!empty($dataSiswa->photo)) ? url('upload/siswa_images/'.$dataSiswa->photo): url('upload/no_image.jpg')}}" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item" href="{{route('siswa.password.edit')}}"><i class="bx bx-cog"></i><span>Change Password</span></a>
							</li>
							...
							<li><a class="dropdown-item" href="{{route('siswa.logout')}}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
